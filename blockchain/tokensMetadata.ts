...
const tokens = [
  ...
  },
  {
    ...
    name: 'Velero',
    icon: 'ether',
    iconCircle: 'vdgt_color',
    iconColor: 'vdgt_color',
    ticker: 'eth-ethereum',
    coinbaseTicker: 'eth-usdc',
    color: '#667FE3',
    background:
  ...
  {
    symbol: 'WAGYULPVLXVDGT',
    precision: 18,
    digits: 5,
    digitsInstant: 2,
    name: 'WAGYULPVLXVDGT',
    icon: 'wagyu_lp_vlxvdgtcircle_color',
    iconCircle: 'wagyu_lp_vlxvdgtcircle_color',
    iconColor: 'wagyu_lp_vlxvdgtcircle_color',
    color: '#ff077d',
    background:
      'linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.05) 100%), linear-gradient(99.1deg, #FA46A7 0%, #FF599F 95.28%), linear-gradient(99.1deg, #FF077D 0%, #FF5B79 95.28%)',
    bannerIcon: staticFilesRuntimeUrl('/static/img/banner_icons/uni.svg'),
  ...
  //   digits: 4,
  //   maxSell: '10000000',
  //   name: 'Velero DAO Governance Token',
  //   icon: AvatarSimple(mkrSvg),
  //   iconCircle: AvatarSimple(mkrSvg),
  //   iconColor: AvatarSimple(mkrSvg),
  //   ticker: 'usdc-usd-coin',
