      ...
      questions: [
        {
          ...
          answer: `Você pode usar os colaterais que são aprovados pela Governança do Velero, incluindo VLX e BTC envelopado ('wrapped BTC'). Você pode ver cada um dos tipos entrando no oasis.app, podendo checar inclusive a Taxa de Estabilidade e Ratio Mínimo de Colateralização.`,
        },

        {
          question: 'Quanto custa?',
          answer: `Abrir e gerir um Cofre (Vault) é grátis no Oasis.app, exceto pelos custos com gás e Taxas de Estabilidade. A Taxa de Estabilidade é cobrada em cima da quantidade de Usdv gerada e é destinada diretamente ao Protocolo Velero.`,
        },

        {
          question: 'Como eu abro um Cofre (Vault)',
          answer: `Para abrir um Cofre, selecione o colateral e seu sub-tipo (ex. VLX-A) na página inicial (oasis.app), connecte sua carteira escolhida e siga as instruções.`,
        },

        {
          question: 'O que é a Taxa de Estabilidade?',
          answer: `A Taxa de Estabilidade é a taxa anual varíavel (mostrada em porcentagem) adicionada a sua dívida - que deverá ser paga. Ela pode ser vista como o custo para gerar Usdv, que é pago diretamente ao Protocolo Velero. Para ler mais sobre a Taxa de Estabilidade por favor cheque nossa [Central de Conhecimento](https://kb.oasis.app/help/the-stability-fee).`,
        },
